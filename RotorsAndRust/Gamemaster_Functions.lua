--Gamemaster_Functions v. 2.3, created by Cake, CTLD-Functions contributed by fargo007
...
GMFunc.RestrToCoal = nil --restricts the usage of the commands to one coalition only, enter 1 to restrict to red, 2 to restrict to blue, nil allows players from both coalitions to use the commands
...
GMFunc.MessageBorderL = ">>>> " --Enter any collection of letters, numbers and/or signs to precede (BorderL) and/or follow (BorderR) Messages sent by the "-text" command. Makes it look nice ;)
GMFunc.MessageBorderR = " <<<<"
...
GMFunc.MessageSound = nil --Sound that plays when a message is sent through the "-text" command, needs to be loaded into the mission at mission start with a trigger using one of the "Sound To .." actions. 
  ...
  if param1 ~= nil
    ...
    then local coalition = nil
         ...
         if coalition ~= nil 
          ...
          then trigger.action.outTextForCoalition(coalition, GMFunc.MessageBorderL .. param1 .. GMFunc.MessageBorderR, DispTime, clearView)
                  ...
                  if GMFunc.MessageSound ~= nil
                  
                    then trigger.action.outSoundForCoalition(coalition, GMFunc.MessageSound)
         ...
         elseif  RecGroup ~= nil
                  ...
                  then local RecID = RecGroup:getID()
                       trigger.action.outTextForGroup(RecID, GMFunc.MessageBorderL .. param1 .. GMFunc.MessageBorderR, DispTime, clearView)
                       ...
                       if GMFunc.MessageSound ~= nil
                          ...
                          then trigger.action.outSoundForGroup(RecID, GMFunc.MessageSound)
                  
                       end
            
         else trigger.action.outText(GMFunc.MessageBorderL .. param1 .. GMFunc.MessageBorderR, DispTime, clearView)
              ...
              if GMFunc.MessageSound ~= nil
                ...
                then trigger.action.outSound(GMFunc.MessageSound)
...
function GMFunc.Spawn(param1, param2, param3, param4, param5, param6, mcoord)
  ...
  if param2 == "kt" or param3 == "kt" or param4 == "kt" or param5 == "kt" or param6 == "op"
...
function GMFunc.CallFunction(param1, param2, param3, param4, param5, param6, param7)
  ...
  if firstIndex ~= nil and sndIndex ~= nil and trdIndex ~= nil
    ...
    then _G[firstIndex][sndIndex][trdIndex](param2, param3, param4, param5, param6, param7)
    
  elseif firstIndex ~= nil and sndIndex ~= nil 
  
    then _G[firstIndex][sndIndex](param2, param3, param4, param5, param6, param7)
    
  elseif firstIndex ~= nil 
  
    then _G[firstIndex](param2, param3, param4, param5, param6, param7)
                ...
                then local full = nil
                     ...
                     elseif cmd == "s"
                      ...
                      then if GMFunc.DebugMode == true
                           ...
                           GMFunc.Spawn(allParams.param1, allParams.param2, allParams.param3, allParams.param4, allParams.param5, allParams.param6, mcoord)
                     ...
                     elseif cmd == "func"
                      ...
                      then if GMFunc.DebugMode == true
                           ...
                           GMFunc.CallFunction(allParams.param1,allParams.param2,allParams.param3,allParams.param4,allParams.param5,allParams.param6,allParams.param7)
